...
| สัปดาห์ที่ (Week) | นาย คุณากร กาดแก้ว 67026966                  | สมาชิกคนที่ 2 |
| ----------------- | -------------------------------------------- | ------------- |
| Week 1            | วางแผนโครงงาน / สร้างโค้ด Scrape             | -             |
| Week 2            | ปรับแก้ไขโค้ด Scraping / ทดสอบระบบ           | -             |
| Week 3            | ออกแบบหน้าเว็บไซต์ Streamlit                 | -             |
| Week 4            | สร้างเว็บไซต์ Streamlit / ทดสอบระบบ / ทำสรุป | -             |
